			...
			<div className="container-fluid">
				...
				<div className="history-box">
					<div className="button">
						<button onClick={(e)=>{setDHistory(false)}} style={{backgroundColor:DHistory? "":"brown", color:setDHistory?  "black":"white"}}>Last Week</button>
						<button onClick={(e)=>{setDHistory(true)}} style={{backgroundColor:DHistory? "brown":"", color:setDHistory?  "white":""}}>Last month</button>
					</div>
